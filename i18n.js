...
window.I18n = {
    ...
    translations: {
        fr: {
            ...
            "header_btn_comparatif": "🔍 Comparatif BRASSE II",
            "comparatif_title": "Comparatif brasseurs d'air — Projet BRASSE II (2025)",
            "comparatif_desc": "Tableau comparatif des 48 brasseurs d'air plafonniers testés dans le cadre du projet BRASSE II. Filtrez par marque, diamètre, bruit et performances.",
            "comparatif_hero_title": "Caractéristiques des brasseurs d'air — Projet BRASSE II",
            "comparatif_hero_desc": "Données extraites des annexes (pages 59-72) du rapport <em>« Brasseurs d'air : une solution de sobriété et d'efficacité — Caractérisation du marché et évaluation des performances »</em>, Juin 2025. &mdash; 48 configurations testées (section 9.1 aéraulique + section 9.2 acoustique).",
            "comparatif_filters": "Filtres",
            "comparatif_label_id": "ID (recherche)",
            "comparatif_label_brand": "Marque",
            "comparatif_label_model": "Modèle (recherche)",
            "comparatif_label_blades": "Nombre de pales",
            "comparatif_label_diam": "Diamètre (cm) min / max",
            "comparatif_label_dist": "Distance plafond (m) min / max",
            "comparatif_label_speeds": "Nombre de vitesses",
            "comparatif_label_db": "Bruit max dB(A) ≤",
            "comparatif_label_rpm": "RPM max ≤",
            "comparatif_label_power": "Puissance max (W) ≤",
            "comparatif_all_marques": "Toutes",
            "comparatif_all": "Tous",
            "comparatif_reset": "Réinitialiser",
            "comparatif_stats_displayed": "configuration(s) affichée(s)",
            "comparatif_stats_out_of": "sur",
            "comparatif_stats_total": "au total",
            "comparatif_th_id": "ID",
            "comparatif_th_brand": "Marque",
            "comparatif_th_model": "Modèle",
            "comparatif_th_blades": "Pales",
            "comparatif_th_diam": "Diamètre (cm)",
            "comparatif_th_dist": "Dist. plafond (m)",
            "comparatif_th_speeds": "Nb vitesses",
            "comparatif_th_rpm_min": "RPM min",
            "comparatif_th_rpm_max": "RPM max",
            "comparatif_th_db_min": "dB(A) min",
            "comparatif_th_db_max": "dB(A) max",
            "comparatif_th_p_min": "P min (W)",
            "comparatif_th_p_max": "P max (W)",
            "comparatif_th_v_min": "V. moy. min (m/s)",
            "comparatif_th_v_max": "V. moy. max (m/s)",
            "comparatif_th_ce_min": "CE min (°C)",
            "comparatif_th_ce_max": "CE max (°C)",
            "comparatif_th_details": "Détails",
            "comparatif_footer_note": "<strong>Source :</strong> Sections 9.1 (Tableaux 4 &amp; 5 : performances aérauliques) et 9.2 (niveau de puissance acoustique) du rapport BRASSE II.<br>&bull; <strong>Section 9.2</strong> (acoustique) : diamètre, nombre de pales, distance plafond, et pour chaque vitesse V1…Vn : RPM et niveau de puissance dB(A). Les colonnes RPM min/max, dB(A) min/max et nb vitesses en découlent.<br>&bull; <strong>Section 9.1</strong> (aéraulique) : puissance électrique min/max (W), vitesse moyenne min/max (m/s), cooling effect (CE) min/max (°C).<br>&bull; 46 configurations sont présentes dans les deux sections ; <em>Wixled Taliou</em> n'a que les données aérauliques et <em>RSOnline</em> n'a que les données acoustiques.<br>&bull; Code couleur bruit : <span class=\"db-low\">vert ≤ 30 dB(A)</span> &middot; <span class=\"db-mid\">orange 30-45 dB(A)</span> &middot; <span class=\"db-high\">rouge &gt; 45 dB(A)</span>.<br>&bull; Cliquez sur un en-tête pour trier ; cliquez sur « Détails » pour voir toutes les vitesses (RPM / dB(A)).",
            ...
            "zone_ventilation_desc_imp": "La sensation de chaleur est lourde ou étouffante. La mise en mouvement de l'air à 197 fpm crée une sensation de fraîcheur immédiate de 3,6°F à 7,2°F, évacuant la sueur et ramenant le ressenti dans la zone de confort.",
            "zone_ventilation_fanDesc_imp": "Génère un flux d'air rafraîchissant de 118 à 197 fpm sur la peau.",
            "zone_climatisation_action_imp": "❄️ Climatisation active. Réglez la consigne à 81°F et activez le brasseur d'air !",
            "zone_climatisation_fanDesc_imp": "Permet de relever le thermostat de clim de 3,6°F pour un confort identique.",
            "physio_desc2_imp": "<strong>1. L'accélération de l'évaporation (Effet principal) :</strong> Notre peau évapore continuellement une infime pellicule d'eau (la transpiration). Le flux d'air accélère cette évaporation. Ce changement d'état liquide-gaz est endothermique : il absorbe directement la chaleur de notre épiderme, créant une baisse immédiate de température cutanée.<br><br><strong>2. La convection forcée :</strong> Notre corps chauffe naturellement l'air qui l'entoure immédiatement, créant une enveloppe d'air chaud et isolante (la couche limite). Le brasseur d'air balaie cette enveloppe chaude pour la remplacer par l'air ambiant de la pièce (s'il est plus frais que la température corporelle, soit < 98,6°F), facilitant la dissipation thermique de notre corps.",
            "physio_title3_imp": "La règle d'or scientifique (197 fpm = -5,4°F)",
            "physio_desc3_imp": "Les études issues des travaux bioclimatiques de Givoni et les normes de confort (ASHRAE 55) s'accordent sur un fait majeur : une vitesse d'air moyenne de <strong>197 fpm</strong> au niveau des occupants équivaut à un rafraîchissement ressenti de <strong>3,6°F à 7,2°F</strong> de moins. Ainsi, à 86°F dans un espace brassé, votre corps se comporte exactement comme s'il faisait 79°F ou 81°F dans une pièce sans courant d'air.",
            "energy_table_th_ac_imp": "Climatiseur (Chambre 130 sq ft)",
            "couplage_desc2_imp": "En faisant fonctionner simultanément un brasseur d'air plafonnier, la sensation de fraîcheur de 3,6°F à 5,4°F vous permet de régler le thermostat de votre climatisation à <strong>81°F au lieu de 77°F</strong> (ou 82°F au lieu de 79°F).<br><br>En physique des bâtiments, <strong>chaque degré supplémentaire sur la consigne de climatisation réduit la consommation d'énergie de 7% à 10%</strong>.",
            "couplage_li1_imp": "<strong>Cas N°1 (Chambre) :</strong> Le couplage (clim réglée à 81°F + BAP) réduit la facture annuelle de climatisation de <strong>27%</strong> par rapport à une clim seule réglée à 77°F. La consommation du brasseur ne pèse que 7% du total.",
            "couplage_li2_imp": "<strong>Cas N°2 (Bureau tertiaire) :</strong> La consigne relevée à 81°F avec le brasseur d'air génère <strong>20% d'économies d'énergie</strong> sur l'année. Le brasseur d'air ne représente que 4% des consommations du bureau.",
            "saisons_desc2_imp": "C'est une loi physique incontournable : l'air chaud (plus léger) monte par convection naturelle et s'accumule sous le plafond. Dans une pièce haute de plafond, l'écart de température peut atteindre 9°F à 18°F entre le sol et le plafond (gaspillage d'énergie massif !).<br><br>En hiver, le brasseur d'air est utilisé pour la <strong>déstratification</strong> :"
        },
        en: {
            // General & Header
            ...
            "header_btn_comparatif": "🔍 BRASSE II Comparison",
            "comparatif_title": "Ceiling Fan Comparison — BRASSE II Project (2025)",
            "comparatif_desc": "Comparative table of the 48 ceiling fans tested in the BRASSE II project. Filter by brand, diameter, noise, and performance.",
            "comparatif_hero_title": "Characteristics of Ceiling Fans — BRASSE II Project",
            "comparatif_hero_desc": "Data extracted from the annexes (pages 59-72) of the report <em>\"Ceiling fans: a solution for sobriety and efficiency — Market characterization and performance evaluation\"</em>, June 2025. &mdash; 48 configurations tested (section 9.1 airflow + section 9.2 acoustics).",
            "comparatif_filters": "Filters",
            "comparatif_label_id": "ID (search)",
            "comparatif_label_brand": "Brand",
            "comparatif_label_model": "Model (search)",
            "comparatif_label_blades": "Number of blades",
            "comparatif_label_diam": "Diameter (cm) min / max",
            "comparatif_label_dist": "Ceiling dist. (m) min / max",
            "comparatif_label_speeds": "Number of speeds",
            "comparatif_label_db": "Max noise dB(A) ≤",
            "comparatif_label_rpm": "Max RPM ≤",
            "comparatif_label_power": "Max power (W) ≤",
            "comparatif_all_marques": "All",
            "comparatif_all": "All",
            "comparatif_reset": "Reset",
            "comparatif_stats_displayed": "configuration(s) displayed",
            "comparatif_stats_out_of": "out of",
            "comparatif_stats_total": "total",
            "comparatif_th_id": "ID",
            "comparatif_th_brand": "Brand",
            "comparatif_th_model": "Model",
            "comparatif_th_blades": "Blades",
            "comparatif_th_diam": "Diameter (cm)",
            "comparatif_th_dist": "Ceiling dist. (m)",
            "comparatif_th_speeds": "No. of speeds",
            "comparatif_th_rpm_min": "Min RPM",
            "comparatif_th_rpm_max": "Max RPM",
            "comparatif_th_db_min": "Min dB(A)",
            "comparatif_th_db_max": "Max dB(A)",
            "comparatif_th_p_min": "Min P (W)",
            "comparatif_th_p_max": "Max P (W)",
            "comparatif_th_v_min": "Min avg V (m/s)",
            "comparatif_th_v_max": "Max avg V (m/s)",
            "comparatif_th_ce_min": "Min CE (°C)",
            "comparatif_th_ce_max": "Max CE (°C)",
            "comparatif_th_details": "Details",
            "comparatif_footer_note": "<strong>Source:</strong> Sections 9.1 (Tables 4 &amp; 5: aerodynamic performance) and 9.2 (sound power level) of the BRASSE II report.<br>&bull; <strong>Section 9.2</strong> (acoustics): diameter, number of blades, ceiling distance, and for each speed V1…Vn: RPM and sound power level dB(A). The columns min/max RPM, min/max dB(A) and number of speeds are derived from this.<br>&bull; <strong>Section 9.1</strong> (aerodynamics): electric power min/max (W), average velocity min/max (m/s), cooling effect (CE) min/max (°C).<br>&bull; 46 configurations are present in both sections; <em>Wixled Taliou</em> only has aerodynamic data and <em>RSOnline</em> only has acoustic data.<br>&bull; Noise color code: <span class=\"db-low\">green ≤ 30 dB(A)</span> &middot; <span class=\"db-mid\">orange 30-45 dB(A)</span> &middot; <span class=\"db-high\">red &gt; 45 dB(A)</span>.<br>&bull; Click a header to sort; click \"Details\" to view all speeds (RPM / dB(A)).",
            ...
            "zone_ventilation_desc_imp": "The sensation of heat is heavy or muggy. Moving air at 197 fpm creates an immediate cooling sensation of 3.6°F to 7.2°F, evaporating sweat and bringing the feeling back to the comfort zone.",
            "zone_ventilation_fanDesc_imp": "Generates a cooling airflow of 118 to 197 fpm on the skin.",
            "zone_climatisation_action_imp": "❄️ Active air conditioning. Set the thermostat to 81°F and turn on the ceiling fan!",
            "zone_climatisation_fanDesc_imp": "Allows raising the AC thermostat by 3.6°F for identical comfort.",
            "physio_desc2_imp": "<strong>1. Evaporation acceleration (Primary effect):</strong> Our skin continuously evaporates a tiny film of water (sweat). The airflow speeds up this evaporation. This liquid-to-gas phase change is endothermic: it directly absorbs heat from our skin, producing an immediate drop in skin temperature.<br><br><strong>2. Forced convection:</strong> Our body naturally heats the air immediately surrounding it, creating a warm, insulating envelope of air (the boundary layer). The fan sweeps away this warm layer and replaces it with ambient room air (if it is cooler than body temperature, i.e., < 98.6°F), facilitating our body's heat dissipation.",
            "physio_title3_imp": "The scientific rule of thumb (197 fpm = -5.4°F)",
            "physio_desc3_imp": "Studies from Givoni's bioclimatic research and comfort standards (ASHRAE 55) agree on a major fact: an average air speed of <strong>197 fpm</strong> around occupants corresponds to a perceived cooling of <strong>3.6°F to 7.2°F</strong> less. Thus, at 86°F in a ventilated space, your body feels exactly as if it were 79°F or 81°F in a draft-free room.",
            "energy_table_th_ac_imp": "Air Conditioner (130 sq ft Bedroom)",
            "couplage_desc2_imp": "By running a ceiling fan simultaneously, the 3.6°F to 5.4°F cooling sensation allows you to set your air conditioning thermostat to <strong>81°F instead of 77°F</strong> (or 82°F instead of 79°F).<br><br>In building physics, <strong>each additional degree on the AC setpoint reduces energy consumption by 7% to 10%</strong>.",
            "couplage_li1_imp": "<strong>Case No. 1 (Bedroom):</strong> Coupling (AC set at 81°F + ceiling fan) reduces the annual AC bill by <strong>27%</strong> compared to AC alone set at 77°F. Fan consumption accounts for only 7% of the total.",
            "couplage_li2_imp": "<strong>Case No. 2 (Tertiary Office):</strong> Raising the setpoint to 81°F with the fan generates <strong>20% energy savings</strong> over the year. The ceiling fan represents only 4% of office consumption.",
            "saisons_desc2_imp": "It is an inescapable physical law: warm air (which is lighter) rises by natural convection and accumulates under the ceiling. In a high-ceilinged room, the temperature gap can reach 9°F to 18°F between the floor and the ceiling (a massive waste of energy!).<br><br>In winter, the ceiling fan is used for <strong>destratification</strong>:"
        }
    },
    init() {
    ...
    applyLanguage() {
        ...
        const isComparatif = window.location.pathname.includes('comparatif.html');
        const titleKey = isGivoni ? "givoni_title" : (isComparatif ? "comparatif_title" : "meta_title");
        const descKey = isGivoni ? "givoni_desc" : (isComparatif ? "comparatif_desc" : "meta_desc");
